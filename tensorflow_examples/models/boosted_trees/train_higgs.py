...
def read_higgs_data(data_dir, train_start, train_count, eval_start, eval_count):
  ...
  try:
    ...
    with tf.io.gfile.GFile(npz_filename, "rb") as npz_file:
...
def train_boosted_trees(flags_obj):
  ...
  if tf.io.gfile.exists(flags_obj.model_dir):
  ...
  logging.info("## Data loaded; train: {}{}, eval: {}{}".format(
  ...
  logging.info("## Features prepared. Training starts...")
